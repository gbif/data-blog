...
* **40** datasets  are reguarly spaced at >0.1 decimal degrees [example](https://www.gbif.org/dataset/81c2b870-f762-11e1-a439-00145eb45e9a)
...
* WGS84 is assumed to calcuate distances in decimal degrees. 
* **All uniuqe occurrence points** from each GBIF dataset have been used this time. This means I was able to flag more datasets.  
