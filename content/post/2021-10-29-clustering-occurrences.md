...
For the remaining eligble records the system first creates a series of "hashes" based on specified fields. All records sharing a hash are candidates to compare against each other.
