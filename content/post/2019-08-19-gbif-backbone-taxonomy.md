...
These checklists are [ordered by priority](https://hosted-datasets.gbif.org/datasets/backbone/backbone-config.yaml) starting with the [Catalogue of Life](https://www.catalogueoflife.org) for most taxa. This order is crucial as it shapes the taxonomy. [Edit 2021-03-09: in the newest version of the backbone from March 2021, the priority list is a bit more complex. Some checklists are used for specific Phyla and will have priority over the Catalogue of Life in the configuration file].
