...
For users getting data through GBIF.org we need to be better at emphasizing the importance of citing using DOIs. We will continue to work with authors and journal editors to improve this.
