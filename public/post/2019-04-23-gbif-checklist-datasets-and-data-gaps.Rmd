...
There are at least 6 dataset catagories **GBIF** classifies as checklists. 

1. **National (or regional) list of species** [example](https://www.gbif.org/dataset/de8934f4-a136-481c-a87a-b0b202b80a31)
2. **Taxanomic list of species** [example](https://www.gbif.org/dataset/7ddf754f-d193-4cc9-b351-99906754a03b)
3. Species description [example](https://www.gbif.org/dataset/02db0742-97fe-4ff8-8917-c8d2591d12a1)
4. Checklists made up of other checklists [GBIF backbone taxanomy](https://www.gbif.org/dataset/d7dddbf4-2cf0-4f39-9b2a-bb099caae36c) & [Catalogue of Life](https://www.gbif.org/dataset/7ddf754f-d193-4cc9-b351-99906754a03b)
...
Not [every name](https://www.gbif.org/species/5141022) in the GBIF backbone has occurrences and names with occurrences are not distributed equally. One way to tell if the GBIF network is collecting occurrences for at least the **named taxanomic** groups is by comparing the **species names in the backbone versus the species names with occurrences**. 
...
We see that the GBIF network has successfully collected occurences for **94% of birds** but only **51% of named insects**. 
...
To explore whether checklists datasets are useful for identifying regional data gaps. I have decided to look at checklist from two regions  and **West Europe** and **West Africa**. These regions represent areas where **data coverage** and **checklist supply** are different. 
