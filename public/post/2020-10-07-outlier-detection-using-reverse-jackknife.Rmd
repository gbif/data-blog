...
The [outlier](https://www.gbif.org/occurrence/865719213) is a **preserved specimen** and occurs close to the centroid of the **Senegal**. The other gray points near the black outlier point are outliers only on this surface. While the outlier in Senegal is an outlier on 7 other surfaces.
...
Currently, there is no outlier detection implemented on GBIF.org. You can view the results of my full GBIF run [here](). 

It is possible to do this in R. 
