...
> **NOTE:** This post has been updated on January 27, 2020 to reflect the new occ_download interface. See dicussions [here](https://github.com/ropensci/rgbif/issues/362).
...
* Greater than 5000 meters eleveation `pred_gt("elevation", 5000)` 
...
# Buidling a complex download requests without rgbif in R 
