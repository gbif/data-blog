...
It has been [suggested](https://discourse.gbif.org/t/hunger-mapping-gbif-data-blog/607/3) that GBIF could make **es50** maps similar to what organizations like **OBIS** are [already doing](https://www.researchgate.net/figure/Hurlberts-index-ES50-calculated-on-a-grid-of-5x5-degrees-ES50-is-the-expected_fig4_242783847). I decided to make one for **land animals** (graph above).  
