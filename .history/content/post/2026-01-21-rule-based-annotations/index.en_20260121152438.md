...
Currently, rules are only available through the [labs.gbif.org/annotations](https://labs.gbif.org/annotations/#/) interface and the R package `gbifrules`. Rules **do not** appear on or get used on the main GBIF.org occurrence search and download systems.



However, we are working on integrating rule-based annotations into the main GBIF.org occurrence search and download systems.
