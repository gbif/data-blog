...
Rules can **express uncertainty** in a way range maps usually cannot. Often you don't need to be an expert to create useful rules for a species or group. Rules can also be **narrowly targeted** to specific datasets, time periods, or record attributes, which makes them useful for addressing known data issues without having to make a definitive range.
