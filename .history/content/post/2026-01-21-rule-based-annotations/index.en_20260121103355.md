...
> **NOTE:** This is an **experimental feature**, and the implementation may change. Please see the [GBIF technical documentation](https://techdocs.gbif.org/en/tools/rule-based-annotations) for the latest updates on the tool. 

Rule based annotations is an experimental tool that will allow users to mark certain occurrence data as suspicious. The main goal of the project is to facilitate occurrence data cleaning and user feedback.
