...
<img src="annotations/make_rule.png" alt="Example rule marking future and past occurrence records of class Amphibia on Iceland as Suspicious" width="80%">
...
<img src="annotations/select_species.png" alt="The user interface for creating rule based annotations" width="80%">
...
<img src="annotations/jwaller_page.png" alt="Example user page showing all rules created by user jwaller" width="80%">
...
<img src="annotations/inverted_polygon.png" alt="This species is only found in Mexico, so all occurrences outside of Mexico are suspicious" width="80%">
...
<img src="annotations/not_fossil.png" alt="There are no extant Amphibian populations in Greenland but there are fossil records" width="80%">
...
<img src="annotations/complex_rules_dialogue.png" alt="The complex rules dialogue" width="80%">
...
<img src="annotations/higher_taxon_rules.png" alt="Higher taxonomy rules" width="80%">
...
<img src="annotations/project_page.png" alt="Example project page" width="80%">
...
<img src="annotations/lions.png" alt="Lions in Europe and North America?" width="80%">
