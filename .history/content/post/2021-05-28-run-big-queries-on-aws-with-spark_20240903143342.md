...
**GBIF** has a [snapshots](https://registry.opendata.aws/gbif/) of billions occurrence<sub>✝</sub> records on **Amazon Web Services** (AWS). This guide will take you through running **Spark notebooks** on AWS. The GBIF snapshot is documented : [here](https://github.com/gbif/occurrence/blob/master/aws-public-data.md).
...
<!-- ![find s3](/post/2021-05-31-aws-and-gbif_files/find_s3_bucket.png) -->
